...
;; Lance/se met sur notepad++
n::
if WinExist("ahk_exe C:\Program Files\Notepad++\notepad++.exe")
	WinActivate, ahk_exe C:\Program Files\Notepad++\notepad++.exe
else
...
;; Lance le programme python en cours dans le CMD
p::
if WinExist("ahk_exe C:\Users\amthi\AppData\Local\Programs\Python\Python36\python.exe") {
	WinClose, ahk_exe C:\Users\amthi\AppData\Local\Programs\Python\Python36\python.exe
	WinActivate, ahk_exe C:\Program Files\Notepad++\notepad++.exe
} else {
	WinActivate, ahk_exe C:\Program Files\Notepad++\notepad++.exe
	SendInput, {Ctrl down}s{Ctrl up}
	sleep 10
	SendInput, {Ctrl down}{Alt down}{Shift down}e
...
sleep 100
SendInput, {ENTER}
tooltip, Compile Latex
sleep 1000
tooltip,
return

f::
if WinExist("ahk_exe C:\Program Files (x86)\foobar2000\foobar2000.exe") {
